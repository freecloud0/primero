    ...
    <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
            <div class="view container07">
                <img class="d-block w-100" src="image/productos01.jpg" alt="First slide">
        ...
        <div class="carousel-item">
            <!--Mask color-->
            <div class="view container07">
                <img class="d-block w-100" src="image/productos01.jpg" alt="Second slide">
        ...
        <div class="carousel-item">
            <!--Mask color-->
            <div class="view container07" >
                <img class="d-block w-100" src="image/productos01.jpg" alt="Third slide">
